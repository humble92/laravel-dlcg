...
<template>
    ...
    <div class="relative flex items-top justify-center min-h-screen bg-gray-100 dark:bg-gray-900 sm:items-center sm:pt-0">
        ...
        <div class="max-w-6xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="mt-8 mb-8 bg-white dark:bg-gray-400 overflow-hidden shadow sm:rounded-lg">
                <div class="divide-y divide-slate-100">
                    <div class="divide-y divide-slate-100">
                        <List v-if="products.data.length">
                            <ListItem v-for="p in products.data" :key="p.product.id" :item="p.product" />
                        </List>
                        <List v-else>
                            <div class="m-3">There are no products.</div>
                        </List>
                    </div>
                </div>
            </div>
